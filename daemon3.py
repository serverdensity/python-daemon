...
class Daemon(object):
    ...
    """
    def __init__(self, pidfile, stdin=os.devnull, stdout=os.devnull, stderr=os.devnull, home_dir='.', umask=int('022', 8), verbose=1, use_gevent=False):
        self.stdin = stdin
        self.stdout = stdout
        self.stderr = stderr
    ...
    def is_running(self):
        ...
        if pid is None:
            ...
            print('Process (pid {}) is running...'.format(pid))
        else:
            print('Process (pid {}) is killed'.format(pid))
